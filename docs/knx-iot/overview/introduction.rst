...
This page introduces the KNX building-automation standard and the KNX IoT Point API that the |addon| implements.
It summarizes the core concepts before the more detailed pages in this section.
